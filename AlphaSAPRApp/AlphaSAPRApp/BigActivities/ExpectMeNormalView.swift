...
struct ExpectMeNormalView: View {
    ...
    private func run(){
        ...
        DispatchQueue.global(qos: .userInteractive).async {
            ...
            let sms = "sms: \(passedContact.phoneNumber)&body=I'm walking back to \(passedLocation.description) with the Expect Me function. Follow me along with your SAPR App"
