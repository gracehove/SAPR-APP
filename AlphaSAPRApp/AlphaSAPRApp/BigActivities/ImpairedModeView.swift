...
//                let sms: String = "sms:\(eachContact.phoneNumber)&body=I'm impaired: Here is my location \(coordinate.latitude) \(coordinate.longitude)"
                ...
                let sms: String = "sms:\(eachContact.phoneNumber)&body=I'm impaired: Here is my location http://www.google.com/maps/place/\(coordinate.latitude),\(coordinate.longitude)"
...
//                let sms = "sms: \(firstContactPhone)&body=I'm impaired: Here is my location \(coordinate.latitude) \(coordinate.longitude)"
                let sms: String = "sms:\(firstContactPhone)&body=I'm impaired: Here is my location http://www.google.com/maps/place/\(coordinate.latitude),\(coordinate.longitude)"
                let strURL: String = sms.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!
                UIApplication.shared.open(URL.init(string: strURL)!, options: [:], completionHandler: nil)
            }
        })
